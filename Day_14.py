...
while True:
    ...
    n = input("Who has more followers? Type 'A' or 'B': ").lower()
    if (n == 'a' and choice_A["follower_count"] > choice_B["follower_count"] or (n == 'b' and choice_A["follower_count"] < choice_B["follower_count"])):
        score += 1
